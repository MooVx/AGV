...
class MotorsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MotorsFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MotorsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MotorsActionFeedback(null);
    ...
    data.feedback = MotorsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MotorsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MotorsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MotorsFeedback()
    }
...
module.exports = MotorsActionFeedback;
