...
if("TRUE" STREQUAL "TRUE")
  set(steward_SOURCE_PREFIX /home/dawid/AGV/Pepperl/src/steward)
  set(steward_DEVEL_PREFIX /home/dawid/AGV/Pepperl/devel)
  set(steward_INSTALL_PREFIX "")
  set(steward_PREFIX ${steward_DEVEL_PREFIX})
else()
  set(steward_SOURCE_PREFIX "")
  set(steward_DEVEL_PREFIX "")
  set(steward_INSTALL_PREFIX /home/dawid/AGV/Pepperl/install)
...
if(NOT "/home/dawid/AGV/Pepperl/devel/include " STREQUAL " ")
  set(steward_INCLUDE_DIRS "")
  set(_include_dirs "/home/dawid/AGV/Pepperl/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'steward' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dawid/AGV/Pepperl/src/steward/${idir}'.  Ask the maintainer 'agv <agv@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dawid/AGV/Pepperl/devel/lib;/opt/ros/kinetic/lib)
